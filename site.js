/* ================================================================
   ABYDOS — site.js  (تم التحويل من Indigena)
   الأقسام الجديدة: زائر, مزار, مقابلات, فعاليات, وجوه, رأي
   ================================================================ */
...
(function () {
  ...
  function thumb(url) {
    return url && url.trim() !== ''
      ? url
      : 'https://placehold.co/600x400/0f1e3a/d4a237?text=Abydos';
  }
  function getSection(post) {
    return post.section || (post.categories || [])[0] || 'زائر';
  }
  ...
  async function init() {
    ...
    try {
      ...
      console.error('[Abydos] Failed to load posts:', err);
      if (dom.postsGrid) {
